/*
** check_err_for_l2.c for check_err_for_l2.c in /home/coulon-b/rendu/CPE_2015_Allum1/lib
** 
** Made by COULON Pierrick
** Login   <coulon_b@epitech.net>
** 
** Started on  Wed Feb 17 17:21:01 2016 COULON Pierrick
** Last update Thu Feb 18 20:07:18 2016 COULON Pierrick
*/
...
int		check_err_for_l_2(t_allum *a, t_gnl *gnl)
{
  ...
  if (gnl->matches[0] - 48 > cpt && gnl->matches[0] != '0'
      && gnl->matches[0] >= 49 && gnl->matches[0] <= 51)
    {
...
int		check_err_for_l_2_b(t_gnl *gnl, int i)
{
  ...
  else if (gnl->matches[0] > '3' && gnl->matches[1] == 0)
    {
      my_putstr("Error: not enough matches on this line");
      return (-1);
    }
